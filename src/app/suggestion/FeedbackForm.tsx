// app/suggestion/FeedbackForm.tsx
"use client";
...
export default function FeedbackForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const templateId = process.env.NEXT_PUBLIC_EMAILJS_TEMPLATE_ID_SUGGESTION as string;
            ...
            <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
              <div>
                ...
                <input
                  ...
                  className="mt-1 block w-full rounded-xl border border-gray-300 bg-white dark:bg-gray-800 dark:border-gray-600 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 dark:focus:border-indigo-400 dark:focus:ring-indigo-400 sm:text-sm p-3 transition-all duration-300"
            ...
            <div className="mt-4 grid grid-cols-1 gap-6 sm:grid-cols-2">
              <div>
                ...
                <p className="mt-2 text-sm text-gray-500 dark:text-gray-400">
                  Share your ideas on how we can improve our services and features.
                </p>
              </div>
              <div>
                <h4 className="text-sm font-medium text-gray-900 dark:text-accent-50 flex items-center">
                ...
                <p className="mt-2 text-sm text-gray-500 dark:text-gray-400">
                  Found an issue? Help us improve by reporting bugs and technical problems.
                </p>
              </div>
            </div>
          </div>
