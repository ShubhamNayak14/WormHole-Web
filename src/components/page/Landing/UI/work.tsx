...
export const HowItWorks = () => {
  ...
  return (
    <section className="lg:min-h-screen text-black dark:text-white transition-colors duration-500 py-16">
      <div className="container mx-auto px-6">
        <h2 className="text-5xl font-bold text-center mb-12 text-gray-900  dark:text-indigo-900">
          How Magic Wormhole Works
        </h2>

        <div className="grid lg:my-50 grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
